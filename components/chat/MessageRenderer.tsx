...
const TableHeaderComponent: React.FC<React.ThHTMLAttributes<HTMLTableHeaderCellElement>> = ({ 
  children, 
  ...props 
}) => (
  <th 
...
const TableDataComponent: React.FC<React.TdHTMLAttributes<HTMLTableDataCellElement>> = ({ 
  children, 
  ...props 
}) => (
  <td 
    className="border border-white/20 px-3 py-2 text-white/90"
    {...props}
  >
    {children}
  </td>
...
const BlockquoteComponent: React.FC<React.BlockquoteHTMLAttributes<HTMLQuoteElement>> = ({ 
  children, 
  ...props 
}) => (
  <blockquote 
      ...
      <div className="relative">
        ...
        <AnimatePresence>
          {showReactions && (
            ...
            >
              <GlassmorphicCard variant="glass-subtle" className="p-2">
...
export const MessageRenderer: React.FC<MessageRendererProps> = memo(({
  ...
  const markdownComponents = useMemo(() => ({
    ...
    h1: ({ children, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
      <h1 className="text-2xl font-bold text-white mb-4 mt-6 border-b border-white/20 pb-2" {...props}>
        {children}
      </h1>
    ),
    ...
    ul: ({ children, ...props }: React.HTMLAttributes<HTMLUListElement>) => (
      <ul className="list-disc list-inside text-white/90 mb-3 space-y-1" {...props}>
        {children}
      </ul>
    ),
    ol: ({ children, ...props }: React.HTMLAttributes<HTMLOListElement>) => (
      <ol className="list-decimal list-inside text-white/90 mb-3 space-y-1" {...props}>
        {children}
      </ol>
    ),
