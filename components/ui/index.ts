...
// Utility Types
export type GlassVariant = 'default' | 'subtle' | 'strong' | 'gradient' | 'gaming' | 'accent-cyan' | 'accent-emerald' | 'accent-rose';
...
export const glassClasses = {
  ...
  subtle: 'backdrop-blur-sm backdrop-saturate-120 bg-white/10 dark:bg-black/10 border border-white/10 dark:border-black/10',
  strong: 'backdrop-blur-lg backdrop-saturate-180 bg-white/25 dark:bg-black/25 border border-white/30 dark:border-black/30',
  
  // Gaming variants
  gaming: 'backdrop-blur-md backdrop-saturate-150 bg-gradient-to-br from-purple-500/20 to-purple-700/30 border border-purple-400/40 shadow-lg shadow-purple-500/20',
  accent: 'backdrop-blur-md backdrop-saturate-150 bg-gradient-to-br from-cyan-500/20 to-purple-600/30 border border-cyan-400/40 shadow-lg shadow-cyan-500/20',
  
  // Interactive states
  hover: 'hover:backdrop-blur-lg hover:backdrop-saturate-180 hover:shadow-lg hover:border-white/40 dark:hover:border-black/40 transition-all duration-300',
  focus: 'focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:ring-offset-2 focus:ring-offset-transparent',
...
export const a11yUtils = {
  ...
  // Focus management
  focusRing: 'focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:ring-offset-2',
