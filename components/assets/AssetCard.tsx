      ...
      >
        ...
        >
          ...
          <div className="p-3 flex-1 flex flex-col">
            <div
              className={clsx(
                "font-medium text-white/90 truncate mb-1",
            ...
            {showMetadata && (
              <div className="flex-1 space-y-1">
                <div
                  className={clsx(
                    "text-white/60 flex items-center justify-between",
                    sizeConfig.text,
                  )}
                >
                  <span>{formatFileSize(asset.size)}</span>
                  {asset.dimensions && <span>{formatDimensions(asset)}</span>}
                </div>
