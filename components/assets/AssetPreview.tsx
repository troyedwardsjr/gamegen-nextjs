      ...
      <div className="flex flex-col items-center space-y-6">
        ...
        <div className="w-full max-w-md space-y-4">
          ...
          <div className="flex items-center space-x-4">
            <GlassmorphicButton variant="gaming" onClick={handlePlay}>
              {isPlaying ? (
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
  ...
  return (
    <div className="flex-1 bg-black/20 rounded-lg p-8">
      <div className="flex flex-col items-center space-y-6">
        ...
        {/* Animation controls */}
        <div className="flex items-center space-x-4">
          <GlassmorphicButton variant="gaming" onClick={handlePlayPause}>
            {isPlaying ? (
        ...
        >
          <GlassmorphicCard className="h-full flex flex-col">
              ...
              <div className="flex items-center space-x-2">
                {onDownload && (
                  ...
                  >
                    ...
                    >
                      <path
                        d="M12 10v6m0 0l-4-4m4 4l4-4m5-5a2 2 0 00-2-2H9a2 2 0 00-2 2v1M5 13a2 2 0 00-2 2v5a2 2 0 002 2h14a2 2 0 002-2v-5a2 2 0 00-2-2H5z"
                        strokeLinecap="round"
            ...
            <div className="flex-1 flex overflow-hidden">
              {/* Preview */}
              <div className="flex-1 p-6">{renderPreview()}</div>
                          ...
                          <div>
                            ...
                            <p className="text-white/90">
                              ...
                              {asset.dimensions.frames &&
                                ` (${asset.dimensions.frames} frames)`}
                              {asset.dimensions.duration &&
                                ` (${Math.round(asset.dimensions.duration)}s)`}
                            </p>
                          </div>
                        )}
                        <div>
                      ...
                      <div className="space-y-3">
                        ...
                        {asset.usage.lastUsed && (
                          <div>
                            ...
                            <p className="text-white/90">
                              {formatDate(asset.usage.lastUsed)}
                            </p>
                          </div>
                        )}
                      </div>
