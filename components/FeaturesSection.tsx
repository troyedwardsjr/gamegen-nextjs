  ...
  const features = [
    {
      ...
      description: "Natural language game development with AI assistance. Describe your game idea and watch as the AI helps you build bullet hell, RPG, action-adventure games and more.",
    },
    {
      icon: <CodeIcon className="w-6 h-6" />,
      title: "Visual Script Editor", 
      description: "Powerful scripting interface with JavaScript support for the Toxoid game engine. Create complex game mechanics with both visual tools and code.",
    },
    {
      icon: <PaletteIcon className="w-6 h-6" />,
      title: "Pixel Art Tools",
      description: "Built-in pixel art editor with sprite animation tools, asset management, and seamless integration with the game development workflow.",
    },
    {
      icon: <SparklesIcon className="w-6 h-6" />,
      title: "AI-Powered Generation",
      description: "Intelligent game mechanics generation, procedural content creation, and smart asset suggestions powered by advanced AI models.",
    },
    {
      icon: <ZapIcon className="w-6 h-6" />,
      title: "Live Preview",
      description: "Real-time game testing and iteration with instant feedback. See your changes immediately as you build and modify your game.",
    },
    {
      icon: <GamepadIcon className="w-6 h-6" />,
      title: "Multi-Platform Export",
      description: "Export to web, desktop (via Tauri), and mobile platforms. Publish to the GameGen marketplace or export for external distribution.",
    },
  ];
      ...
      >
        ...
        >
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mx-auto">
            Transform your game ideas into reality with cutting-edge AI technology designed 
            for indie developers, artists, and creative minds.
          </p>
        </motion.div>
        ...
        >
          <div className="max-w-2xl mx-auto space-y-4 sm:space-y-6">
            ...
            <p className="text-sm sm:text-base text-white/70">
              Join thousands of creators who are already building amazing games with AI-powered tools.
            </p>
          </div>
        </motion.div>
      </motion.div>
