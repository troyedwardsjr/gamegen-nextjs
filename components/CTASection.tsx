      ...
      >
        ...
        <motion.div
          ...
          style={{
            ...
            boxShadow: '0 16px 64px rgba(132,61,255,0.2), inset 0 1px 2px rgba(255,255,255,0.1)',
          }}
        >
          ...
          <div className="absolute top-16 right-16 w-1 h-1 bg-violet-400/30 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
          <div className="absolute bottom-8 left-8 w-1.5 h-1.5 bg-indigo-400/35 rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
              ...
              >
                {[
                  ...
                  >
                    ...
                    <div className="font-bold text-white/95 text-lg">{value}</div>
