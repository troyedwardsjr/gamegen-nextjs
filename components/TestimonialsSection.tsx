  ...
  const testimonials = [
    {
      ...
      avatar: "AC",
      quote: "GameGen transformed my workflow completely. I went from concept to playable game in just 3 days. The AI assistance is incredibly intuitive and the pixel art tools are exactly what I needed.",
      rating: 5,
    },
    {
      ...
      role: "Digital Artist",
      avatar: "SR",
      quote: "The vibe coding chat is a game-changer. I can describe complex mechanics in plain English and watch them come to life. It's like having a coding partner who never gets tired.",
      rating: 5,
    },
    {
      ...
      avatar: "MT",
      quote: "Our studio has adopted GameGen for rapid prototyping. We've created over 20 game demos this month alone. The export options make it perfect for client presentations.",
      rating: 5,
    },
  ];
      ...
      >
        ...
        >
          ...
          <p className="text-sm sm:text-base md:text-lg text-white/70 leading-relaxed">
            Join thousands of developers who are creating amazing games with GameGen
          </p>
        </motion.div>
          ...
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              whileHover={shouldReduceMotion ? undefined : {
                scale: 1.02,
                y: -5,
                boxShadow: '0 16px 48px rgba(132,61,255,0.25), inset 0 1px 2px rgba(255,255,255,0.12)',
              }}
            >
              {/* Hover effects */}
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="flex items-center gap-3">
                  <div 
                    ...
                    style={{
                      background: 'linear-gradient(135deg, rgba(132,61,255,0.4) 0%, rgba(168,85,247,0.3) 100%)',
