...
export function UserStats({ stats, className, variant = "default" }: UserStatsProps) {
...
export function UserStatsSkeleton({ variant = "default", className }: { variant?: "default" | "compact" | "detailed", className?: string }) {
    ...
    return (
      <div className={`space-y-4 ${className}`}>
        {Array.from({ length: count }).map((_, index) => (
          <div key={index} className="flex items-center justify-between p-3 rounded-lg bg-white/5 dark:bg-black/5">
            <div className="flex items-center gap-3">
