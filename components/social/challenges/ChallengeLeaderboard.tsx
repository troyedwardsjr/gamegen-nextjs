            ...
            <div className="flex items-end justify-center gap-4">
              ...
              {topThree[1] && (
                ...
                >
                  ...
                  <Avatar src={topThree[1].avatar_url || undefined} name={topThree[1].display_name || topThree[1].username} size="md" className="mb-2" />
                  <div className="text-sm font-semibold">{topThree[1].display_name || topThree[1].username}</div>
                  <div className="text-xs text-foreground/60">{topThree[1].score.toLocaleString()} pts</div>
                </motion.div>
              )}
              ...
              {topThree[0] && (
                ...
                >
                  ...
                  <Avatar src={topThree[0].avatar_url || undefined} name={topThree[0].display_name || topThree[0].username} size="lg" className="mb-2" />
                  <div className="text-sm font-semibold">{topThree[0].display_name || topThree[0].username}</div>
                  <div className="text-xs text-foreground/60">{topThree[0].score.toLocaleString()} pts</div>
                </motion.div>
              )}
              ...
              {topThree[2] && (
                ...
                >
                  ...
                  <Avatar src={topThree[2].avatar_url || undefined} name={topThree[2].display_name || topThree[2].username} size="sm" className="mb-2" />
                  <div className="text-sm font-semibold">{topThree[2].display_name || topThree[2].username}</div>
                  <div className="text-xs text-foreground/60">{topThree[2].score.toLocaleString()} pts</div>
                </motion.div>
              )}
            </div>
          </div>
              ...
              >
                ...
                {showScores && (
                  <div className="text-right">
                    ...
                    <div className="text-xs text-foreground/60">{entry.votes_received} votes</div>
                  </div>
                )}
              </motion.div>
            ))}
