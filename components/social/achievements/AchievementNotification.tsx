...
export function AchievementNotification({
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {[...Array(20)].map((_, i) => (
          <motion.div
            ...
            style={{
              backgroundColor: i % 4 === 0 ? rarityConfig.color : 
                               i % 4 === 1 ? "#FFD700" :
                               i % 4 === 2 ? "#FF6B6B" : "#4ECDC4",
  ...
  const renderSparkles = () => {
    if (achievement.rarity !== "legendary" && achievement.rarity !== "mythic") return null;
    ...
    return (
      <div className="absolute inset-0 pointer-events-none">
        {[...Array(8)].map((_, i) => (
          ...
          >
            <Sparkles size={12} className="text-white drop-shadow-[0_0_4px_rgba(255,255,255,0.8)]" />
          </motion.div>
        ))}
      </div>
    );
  ...
  const renderToastView = () => (
    ...
    >
      ...
      >
        ...
        >
          <div className={`absolute inset-0 bg-gradient-to-br ${rarityConfig.bgGradient}`} />
        ...
        >
          ...
          <div className="relative p-8 text-center">
            ...
            <div className="mb-6">
              ...
              <div className="inline-flex items-center gap-2 bg-primary/20 backdrop-blur-sm rounded-full px-4 py-2">
                <Trophy size={16} />
                <span className="font-semibold">+{achievement.points} Points Earned</span>
              </div>
            </div>
  ...
  const renderBannerView = () => (
    <motion.div
      ...
      exit="exit"
    >
      <div className={`relative overflow-hidden ${rarityConfig.borderColor} border-b-2`}>
        <div className={`absolute inset-0 bg-gradient-to-r ${rarityConfig.bgGradient} backdrop-blur-md`} />
