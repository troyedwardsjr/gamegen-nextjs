      ...
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(132,61,255,0.15) 0%, rgba(168,85,247,0.12) 50%, rgba(139,92,246,0.15) 100%)",
              border: "1px solid rgba(132,61,255,0.3)",
              boxShadow:
                "0 8px 32px rgba(132,61,255,0.2), inset 0 1px 2px rgba(255,255,255,0.1)",
            }}
            transition={{ duration: 0.5 }}
            whileHover={{
              scale: 1.05,
              boxShadow:
                "0 12px 48px rgba(132,61,255,0.3), inset 0 1px 2px rgba(255,255,255,0.2)",
            }}
          >
          ...
          >
            Transform your game ideas into reality with our vibe coding chat
            interface, visual scripting tools, and AI-powered game generation.
            Create bullet hell, RPG, action-adventure games and more.
          </motion.p>
          ...
          >
            {[
              ...
              <motion.div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(255,255,255,0.08) 0%, rgba(132,61,255,0.08) 50%, rgba(255,255,255,0.08) 100%)",
                ...
                whileHover={{
                  scale: 1.05,
                  boxShadow:
                    "0 12px 48px rgba(132,61,255,0.25), inset 0 1px 2px rgba(255,255,255,0.15)",
                }}
              >
                {/* Hover glow effect */}
