...
export const isSame = (date1: DateInput, date2: DateInput, unit: TimeUnit = 'milliseconds'): boolean => {
...
export const isBetween = (date: DateInput, start: DateInput, end: DateInput, inclusive = true): boolean => {
...
// Date arithmetic
export const addTime = (date: DateInput, amount: number, unit: TimeUnit): Date => {
  const d = createDate(date);
...
export const subtractTime = (date: DateInput, amount: number, unit: TimeUnit): Date => {
...
export const differenceInMilliseconds = (date1: DateInput, date2: DateInput): number => {
  return createDate(date1).getTime() - createDate(date2).getTime();
};

export const differenceInSeconds = (date1: DateInput, date2: DateInput): number => {
...
export const differenceInWeeks = (date1: DateInput, date2: DateInput): number => {
  return Math.floor(differenceInDays(date1, date2) / 7);
};

export const getTimeDifference = (date1: DateInput, date2: DateInput): TimeDifference => {
...
export const formatGameSessionDuration = (startTime: DateInput, endTime?: DateInput): string => {
...
export const getNextMilestone = (createdDate: DateInput): { date: Date; days: number; label: string } => {
...
// Calendar utilities
export const getCalendarDays = (date: DateInput, firstDayOfWeek = 0): Date[] => {
...
export const getWeekdays = (locale = 'en-US', format: 'long' | 'short' | 'narrow' = 'short'): string[] => {
...
export const getMonthNames = (locale = 'en-US', format: 'long' | 'short' | 'narrow' = 'long'): string[] => {
  const months: string[] = [];
