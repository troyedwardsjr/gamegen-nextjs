...
export const editorStorage = {
  ...
  saveState: (state: any) =>
    sessionStorage.setItem(STORAGE_KEYS.GAME_EDITOR_STATE, state),
...
export const recentGamesStorage = {
  getRecentGames: (): any[] =>
    localStorage.getItem(STORAGE_KEYS.RECENT_GAMES) || [],
...
export const canvasStorage = {
  ...
  saveSettings: (settings: any) =>
    localStorage.setItem(STORAGE_KEYS.CANVAS_SETTINGS, settings),
