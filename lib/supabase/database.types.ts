    ...
    Tables: {
      ...
      games: {
        Row: {
          ...
          tags: string[]
          genre: 'platformer' | 'shooter' | 'puzzle' | 'rpg' | 'racing' | 'strategy' | 'casual' | 'educational' | null
          game_data: Json
      ...
      script_execution_logs: {
        Row: {
          ...
          execution_phase: 'initialization' | 'pre_update' | 'update' | 'post_update' | null
          success: boolean
      ...
      templates: {
        Row: {
          ...
          name: string
          description: string | null
          category: 'educational' | 'commercial' | 'entertainment' | 'tutorial' | null
