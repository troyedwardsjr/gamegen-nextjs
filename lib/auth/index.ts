...
export const AuthUtils = {
   ...
   */
  formatUserName: (firstName?: string, lastName?: string, email?: string): string => {
  ...
  isFeatureAvailable: (tier: string, feature: string): boolean => {
    const permissions = AuthUtils.getPermissionsForTier(tier as keyof typeof TIER_PERMISSIONS)
