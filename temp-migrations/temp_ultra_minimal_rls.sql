-- Migration: Create Ultra-Minimal RLS Policies (Critical Tables Only)
-- Description: Address the most critical security advisor findings first
-- Date: 2025-09-09
...
-- =======================
-- COMMERCE POLICIES (READ-ONLY FOR USERS)
-- =======================
...
COMMENT ON POLICY "Users can view public games" ON games IS 'Core game visibility control';