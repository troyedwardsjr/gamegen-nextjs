-- Migration: Create Basic RLS Policies for Core Tables (Minimal Safe Version)
-- Description: Address security advisor findings with basic secure policies
-- Date: 2025-09-09
...
-- =======================
CREATE POLICY "Users can view versions of their own games"
...
-- =======================
CREATE POLICY "Users can view assets of their own games"
...
-- =======================
CREATE POLICY "Users can view scripts of their own games"
...
-- =======================
-- SOCIAL POLICIES (OPEN FOR BASIC FUNCTIONALITY)
-- =======================
...
COMMENT ON POLICY "Users can view public games and manage their own" ON games IS 'Games use visibility column for access control';
COMMENT ON POLICY "Public access to game embeddings" ON game_embeddings IS 'Embeddings are used for search and recommendations';