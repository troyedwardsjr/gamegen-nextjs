-- Migration: Create RLS Policies for Core Tables
...
-- =======================
CREATE POLICY "Users can view published games and their own games"
ON games FOR SELECT
...
-- =======================
CREATE POLICY "Users can view public patterns and their own patterns"
...
-- =======================
CREATE POLICY "Users can view public community assets"
...
COMMENT ON POLICY "Users can view their own profile and public profiles" ON profiles IS 'Users can access their own profile and view public profiles';
COMMENT ON POLICY "Users can view published games and their own games" ON games IS 'Users can view public games and their own private games';
COMMENT ON POLICY "Users can view public patterns and their own patterns" ON toxoid_patterns IS 'Toxoid patterns can be public or private to creator';
COMMENT ON POLICY "Users can view public community assets" ON community_assets IS 'Community assets are shareable resources';
COMMENT ON POLICY "Users can view all game likes (public engagement data)" ON game_likes IS 'Game likes are public engagement metrics';