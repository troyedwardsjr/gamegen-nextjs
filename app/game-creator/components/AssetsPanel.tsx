...
const SpritesTab = () => {
  ...
  const sprites = mockAssets.filter(asset => 
        ...
        {sounds.map((asset) => (
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-2">
                {asset.inUse && (
                  <GlassmorphicBadge variant="success" size="sm">
                    In Use
                  </GlassmorphicBadge>
                )}
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                ...
                <GlassmorphicButton
                  variant="gaming"
                  size="sm"
                  onClick={() => setPreviewingAnimation(
...
const LibraryTab = () => {
  ...
  const categories = [
    ...
    { id: "sprites", label: "Sprites", count: mockAssets.filter(a => a.type === "sprite").length },
    { id: "tilesets", label: "Tilesets", count: mockAssets.filter(a => a.type === "tileset").length },
    { id: "audio", label: "Audio", count: mockAssets.filter(a => ["sound", "music"].includes(a.type)).length },
    { id: "animations", label: "Animations", count: mockAssets.filter(a => a.type === "animation").length },
  ];
  ...
  const filteredAssets = selectedCategory === "all" 
    ...
    : mockAssets.filter(asset => {
        switch (selectedCategory) {
          case "sprites": return asset.type === "sprite";
          case "tilesets": return asset.type === "tileset";
          case "audio": return ["sound", "music"].includes(asset.type);
          case "animations": return asset.type === "animation";
          default: return true;
        }
      });
        ...
        <div className="grid grid-cols-2 gap-1">
          {categories.map((category) => (
            ...
            >
              ...
              <GlassmorphicBadge variant="subtle" size="sm">
                {category.count}
              </GlassmorphicBadge>
            </GlassmorphicButton>
          ))}
      ...
      <div className="p-3 border-b border-white/10">
        <div className="grid grid-cols-3 gap-2 text-center">
          <div>
            ...
            <div className="text-sm font-semibold text-white/90">{mockAssets.length}</div>
          </div>
          <div>
...
export function AssetsPanel() {
  ...
  const tabs: Tab[] = [
    ...
    },
    {
      ...
      content: <SoundsTab />,
      badge: mockAssets.filter(a => ["sound", "music"].includes(a.type)).length,
    },
    {
      id: "animations",
      label: "Anims",
