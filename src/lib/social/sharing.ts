...
export class GameSharing {
  static generateGameShareContent(
    game: Game,
    ...
    return {
      ...
      description:
        game.description || "An amazing pixel art game created with GameGen!",
      url: gameUrl,
...
export class AchievementSharing {
  ...
  static shareAchievementToTwitter(
    achievement: Achievement,
    user: { username: string; display_name: string },
  ): string {
      ...
      embeds: [
        {
          ...
          thumbnail: achievement.icon_url
            ? { url: achievement.icon_url }
            : undefined,
          fields: [
            {
              name: "Points Earned",
      ...
      embeds: [
        {
          ...
          image: challenge.banner_url
            ? { url: challenge.banner_url }
            : undefined,
          thumbnail: challenge.thumbnail_url
            ? { url: challenge.thumbnail_url }
            : undefined,
          fields: [
            {
              name: "Type",
...
export class SocialSharing {
  ...
  static generateMetaTags(content: ShareableContent) {
    return {
      ...
      "og:url": content.url,
      "og:image":
        content.imageUrl || `${process.env.NEXT_PUBLIC_APP_URL}/og-default.png`,
      "og:type": "website",
