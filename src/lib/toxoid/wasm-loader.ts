...
const WASM_PATHS = {
  dev: '/toxoid/toxoid_dev.wasm',
  prod: '/toxoid/toxoid.wasm',
  webgl_dev: '/toxoid/toxoid_webgl_dev.wasm',
  webgl_prod: '/toxoid/toxoid_webgl.wasm',
} as const;

const JS_GLUE_PATHS = {
  dev: '/toxoid/toxoid_dev.js',
  prod: '/toxoid/toxoid.js',
  webgl_dev: '/toxoid/toxoid_webgl_dev.js',
  webgl_prod: '/toxoid/toxoid_webgl.js',
} as const;
